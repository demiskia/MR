### MR script for Mona (last edited by Demis 9/5/17 ###
...
### Read in your files...
exposure_snps <- read.delim("codd_iv2.txt", header=TRUE, sep="\t", stringsAsFactors=FALSE)
# pd_snps <-read.table("C:/Users/dkia/Desktop/AllResults.txt", header=TRUE, sep="\t", stringsAsFactors=FALSE)
